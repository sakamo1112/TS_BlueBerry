...
var get3_1 = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var ReadWrite = function () { return __awaiter(_this, void 0, void 0, function () {
    var _a, readFile, writeFile, readdata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                readdata = _b.sent();
                return [4 /*yield*/, writeFile('data/bar.txt', readdata + readdata)];
            case 3:
                _b.sent();
                return [2 /*return*/];
        }
